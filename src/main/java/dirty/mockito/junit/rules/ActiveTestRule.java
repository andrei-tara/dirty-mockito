...
/**
 * <p>
 * JUnit 4.7 {@link org.junit.Rule} that performs instantiation, mocking and injection of mocks. Uses reflection to
 * instantiate objects, Mockito to perform mocking of elements annotated with <a href=
 * "http://mockito.googlecode.com/svn/branches/1.6/javadoc/org/mockito/Mock.html" ><code>&#064;Mock</code></a>, and an
 * internal Spring BeanFactory to perform injection of mocks into fields (in the object under test) annotated with
 * <code>&#064;Autowired</code>.
 * </p>
 * <p>
 ...
 * </pre>
 * <p>
 * Now, to write a unit test for <code>WidgetDao</code> using <code>ActiveTestRule</code>, we simply add a
 * {@link org.junit.Rule} <code>ActiveTestRule&lt;WidgetDao&gt;</code>, declare a field of type <code>WidgetDao</code>,
 * declare another field of type <code>Entitymanager</code> and annotate that using <code>&#064;Mock</code>.
 *
 * <pre>
 * public class WidgetDaoTest {
 *     &#064;Rule
 *     public ActiveTestRule&lt;WidgetDao&gt; activeTestRule = ActiveTestRule.thatWorksOn(WidgetDao.class);
 *
 *     &#064;Mock
 *     private EntityManager em;
 *
 ...
 * </pre>
 * <p>
 * That's it. ActiveTestRule takes care of creating the mocks for fields annotated <code>&#064;Mock</code>,
 * instantiating the class under test ( <code>WidgetDao</code>), and injecting the mock objects into
 ...
 * @see <a href="http://code.google.com/p/dirty-mockito/" target="_blank">dirty-mockito</a>
 * @see <a href=
...
public class ActiveTestRule<T> extends MockingRule {
     ...
     */
    public static <T> ActiveTestRule<T> thatWorksOn(final Class<T> classUnderTest) {
    ...
    private void registerMockEntityManagerFactory(final EntityManager em) {
        final MockEntityManagerFactory mockEntityManagerFactory = new MockEntityManagerFactory(em);
        beanFactory.registerSingleton("entityManagerFactory", mockEntityManagerFactory);
